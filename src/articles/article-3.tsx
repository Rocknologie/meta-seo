...
export const Article3Page: React.FC = () => (
    <div>
        ...
        <Image alt='agence de seo' src='/img/articles/agence-de-seo.png' size='large'/>        
        ...
        <Image alt='question' src='/img/articles/question.png' size='large'/>
        ...
        <Image alt='types de référencement' src='/img/articles/types-de-referencement.png' size='large'/>
