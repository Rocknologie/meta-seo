...
export const AgenceLyonPage: React.FC = () => (    
    <div>
        <MetaTags>
            <title>Agence Lyon - Meta-SEO</title>
            <meta name="description" content="Agence de Meta-SEO basée à Lyon." />
        </MetaTags>
        
        <LineFeed />    
        <Header as='h1' color='black'>Notre agence SEO de Lyon</Header> 
